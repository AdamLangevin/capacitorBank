...
paypal.configure({
  ...
  'client_id': 'AYW71pmsVrx_epHDd0kWbXP_jvFVFm72xuCumBU1zYjU68Hq558lTtTXWCxSls-s-uwYpGoUAdeAA4Xd',
  'client_secret': 'EFnR4yvre7mWHHoagJU_yjHbXPc5ggSdS5bpxbuKCypaCnmw8Q6Mg3XF8J3-Hh8vgTtOEfuo48IBRXFv'
});
...
app.use(session({
  ...
  cookie            : {maxAge: 120 * 60 * 1000} // 2 hours later the session experies
}));
